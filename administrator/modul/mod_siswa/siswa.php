        ...
        <div class=\"box-inner\">
            ...
            <div class=\"box-content\">
                <form role=\"form\" class=\"cmxform\" id=\"form1\" method=\"POST\" action=\"$aksi?module=siswa&act=inputsiswa\" >
                    ...
                    <div class=\"form-group\">
                        <label>NIM</label>
                        <input type=\"text\" class=\"form-control\"  name=\"nisn\" required oninvalid=\"this.setCustomValidity('NIM tidak boleh kosong')\" oninput=\"setCustomValidity('')\">
                    </div>
                     <div class=\"form-group\">
                     ...
                     <div class=\"form-group\">
                        <label>Jurusan</label>
                        <input type=\"text\" class=\"form-control\"  name=\"kelas\" required oninvalid=\"this.setCustomValidity('Jurusan tidak boleh kosong')\" oninput=\"setCustomValidity('')\" >
                    </div>
                    <div class=\"form-group\">
        ...
        <div class=\"box-inner\">
            ...
            <div class=\"box-content\">
                <form role=\"form\" class=\"cmxform\" id=\"form1\" method=\"POST\" action=\"$aksi?module=siswa&act=update\" >
                    ...
                    <div class=\"form-group\">
                        <label>NIM</label>
                        <input type=\"text\" class=\"form-control\"  name=\"nisn\" value=\"$r[nisn]\" required oninvalid=\"this.setCustomValidity('NIM tidak boleh kosong')\" oninput=\"setCustomValidity('')\" readonly>
                    </div>
                     <div class=\"form-group\">
                        <label>Nama Siswa</label>
                     ...
                     <div class=\"form-group\">
                        <label>Jurusan</label>
                        <input type=\"text\" class=\"form-control\"  name=\"kelas\" value=\"$r[kelas]\" required oninvalid=\"this.setCustomValidity('Jurusan tidak boleh kosong')\" oninput=\"setCustomValidity('')\" >
                    </div>
                    <div class=\"form-group\">
                        <label>Tempat Lahir</label>
