...
<div class=" row">
    ...
    <div class="col-md-3 col-sm-3 col-xs-6">
        <?php $penerbit = mysql_fetch_array(mysql_query("SELECT count(*) as total FROM penerbit")); ?>
    ...
    <div class="col-md-3 col-sm-3 col-xs-6">
        <?php $buku = mysql_fetch_array(mysql_query("SELECT count(*) as total FROM buku")); ?>
    ...
    <div class="col-md-3 col-sm-3 col-xs-6">
        <?php $grafik = mysql_fetch_array(mysql_query("SELECT count(*) as total FROM peminjaman")); ?>
